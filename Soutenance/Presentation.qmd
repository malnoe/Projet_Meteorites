...
<div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 2em;">
...
- *Traitement des données* :  
  - Nettoyage, filtrage, log(masse)  
  - Jointure spatiale avec shapefile externe

- *Globe 3D* :  
  - Projection orthographique  
  - Taille = masse, Couleur = année  
  - Annotations dynamiques : total + top 10 pays
